...
class TestBowlingGame(unittest.TestCase):
    ...
    def testLastFrameStrike(self):
        ...
        self.game.a_roll(10)  # Strike in the last frame
        self.game.a_roll(3)
        self.game.a_roll(6)  # Bonus rolls
        assert self.game.score() == 19


    def testLastFrameSpare(self):
        self.rollMany(0, 18)  # First 9 frames are gutter balls
        self.game.a_roll(5)
        self.game.a_roll(5)  # Spare in the last frame
        self.game.a_roll(3)  # Bonus roll
